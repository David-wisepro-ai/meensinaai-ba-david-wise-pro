...
export const PM_AULAS: Aula[] = [
  ...
  { titulo: 'Leituras de Plantas para Orçamentos e Change Orders', descricao: 'Como interpretar plantas para elaborar orçamentos precisos e gerenciar change orders na obra.', videoUrl: 'https://drive.google.com/file/d/1ugAZqfNC3kE6ujw4eqGIgrpBNaizbRrc/view' },
  { titulo: 'Inteligência Artificial para Gestão de Projetos na Construção', descricao: 'Como usar inteligência artificial para planejar, organizar e gerenciar projetos na construção.', videoUrl: 'https://drive.google.com/file/d/1F-vNm-4EhTzfOjYX_p6QvjuhPzKLsjtz/view' },
